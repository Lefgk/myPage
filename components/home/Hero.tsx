  ...
  return (
    <>
      <div
        ...
        style={{ maxWidth: "1200px", paddingBottom: "0" }}
      >
        <p className="text-xl mb-5">
          E<span className="text-fun-pink">lef</span>
          therios Giakoumakis
        </p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          I enjoy{" "}
          <span className="heroShiny1 text-fun-pink">writing, auditing</span>{" "}
          smart contracts and{" "}
          <span className="heroShiny2 text-fun-pink">integrating</span> them in
          dapps.
        </h1>
        <ScrollLink
          activeClass="active"
